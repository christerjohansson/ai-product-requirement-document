...
Welcome to **AI agent developer tasks**! This repo is basically a cheat code for taming your AI coding sidekick. Inside: a stash of markdown files custom-built to turbocharge your feature dev workflow, whether you’re rolling with Cursor, Claude Code, Windsurf, or whatever shiny new AI assistant claims it can replace 12 senior engineers and your coffee machine. These structured prompts turn chaotic "do everything at once" AI requests into bite-sized, repeatable feature-building steps—like giving your AI a GPS so it stops driving your project into a ditch. You get checkpoints, sanity checks, and fewer "wait, why did it rename every variable again?" moments.

Quit suplexing your code with giant monolithic prompts. Start tag-teaming with your AI, step by step, like a proper buddy-cop duo for software development.
...
2. In your AI tool, initiate PRD creation:
    ...
    *(Pro Tip: For Cursor users, MAX mode is recommended for complex PRDs if your budget allows for more comprehensive generation.)*
    ...
    ![Example of initiating PRD creation](/img/1.png)
...
2. In your AI tool, use the PRD to create tasks:
    ...
    *(Note: Replace `@MyFeature-PRD.md` with the actual filename of the PRD you generated in step 1.)*
    ...
    ![Example of generating tasks from PRD](img/prd-generation-example.png)

### 3️⃣ Examine Your Task List

You'll now have a well-structured task list, often with tasks and sub-tasks, ready for the AI to start working on. This provides a clear roadmap for implementation.

![Example of a generated task list](img/task-list-example.png)
...
2. In your AI tool, tell the AI to start with the first task (e.g., `1.1`):
    ...
    *(Important: You only need to reference `@process-task-list.md` for the *first* task. The instructions within it guide the AI for subsequent tasks.)*
    ...
    ![Example of starting on a task with process-task-list.md](img/task-processing-example.png)
...
![Example of a progressing task list with completed items](img/task-progress-example.png)
...
1. **Clone or Download:** Get these `.md` files into your project or a central location where your AI tool can access them.
   ```bash
   git clone https://github.com/christerjohansson/ai-product-requirement-document.git
   ```
